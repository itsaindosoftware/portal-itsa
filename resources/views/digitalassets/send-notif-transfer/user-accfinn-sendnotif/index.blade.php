...
$(document).on('click','#approval-data', function(e) {
	...
	var approvalDate6 = $(this).attr('row-approve6');
	var approvalStatus6 = $(this).attr('row-status5');
	// alert(approvalDate6)
	if (approvalDate6 && approvalStatus6 === '1') {
		Swal.fire({
	...
	if (approvalDate6 && approvalStatus6 === '2') {
		Swal.fire({
...
$(document).on('click','#reject-data', function(e) {
	...
	var approvalDate6 = $(this).attr('row-approve6');
	var approvalStatus6 = $(this).attr('row-status6');
	// alert(approvalDate6)
	if (approvalDate6 && approvalStatus6 === '1') {
		Swal.fire({
			title: 'Already Approved',
