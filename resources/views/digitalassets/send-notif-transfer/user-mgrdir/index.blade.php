...
$(document).on('click','#approval-data', function(e) {
	...
	var approvalStatus2 = $(this).attr('row-status2');
	// alert(approvalDate2)
	if (approvalDate2 && approvalStatus2 === '1') {
		Swal.fire({
	...
	if (approvalDate2 && approvalStatus2 === '2') {
		Swal.fire({
...
$(document).on('click','#reject-data', function(e) {
	...
	var approvalDate2 = $(this).attr('row-approve2');
	var approvalStatus2 = $(this).attr('row-status1');
	// alert(approvalDate2)
	if (approvalDate2 && approvalStatus2 === '1') {
		Swal.fire({
			title: 'Already Approved',
