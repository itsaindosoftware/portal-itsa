                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="date" class="form-control enhanced-input" id="received_date" name="received_date" 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="issue_fixed_asset_no" name="issue_fixed_asset_no" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="io_no" name="io_no" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="product_code" name="product_code" 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="product_name" name="product_name" 
                    ...
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="grn_no" name="grn_no" 
                                ...
                                <div class="col-md-4">
                                    <div class="form-check enhanced-radio">
                                        <input class="form-check-input" type="radio" 
                                            ...
                                            name="asset_group" 
                                            value="{{ $group->id }}"
                                            {{ old('asset_group', $asset->asset_group_id) == $group->id ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check enhanced-radio">
                                        <input class="form-check-input" type="radio"
                                            ...
                                            name="asset_location"
                                            value="{{ $location->id }}"
                                            {{ old('asset_location', $asset->asset_location_id) == $location->id ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-check enhanced-radio">
                                        <input class="form-check-input" type="radio"
                                            ...
                                            value="{{ $costCenter->id }}"
                                            {{ old('asset_cost_center', $asset->asset_cost_center_id) == $costCenter->id ? 'checked' : '' }}>
