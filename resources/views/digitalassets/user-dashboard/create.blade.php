        ...
        <div class="card-header enhanced-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">Please fill all required information carefully</small>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="date" class="form-control enhanced-input" id="date" name="date" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group enhanced-form-group">
                            ...
                            <input type="text" class="form-control enhanced-input" id="rfa_number" name="rfa_number" required>
                            <small class="form-text text-muted">
                                <i class="fas fa-user-tie mr-1"></i>(Fill by Accounting)
                            </small>
                        </div>
