				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table table-bordered dataTable no-footer" id="table-permission-manage" width="100%" role="grid" aria-describedby="table-1_info">
								<thead>
									<tr>
										<th width="7%">No.</th>
										<th>Name Module</th>
		...
		rowGroup: {
           dataSrc: 'name_module',
            startRender: function (rows, group) {
                return $('<tr/>')
                    .append('<td colspan="6" style="background-color: #f0f0f0; font-weight: bold;">' + group + '</td>');
            }
        }
//
