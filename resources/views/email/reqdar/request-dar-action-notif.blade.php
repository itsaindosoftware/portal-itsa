...
<body>
    ...
    <div class="content">
        ...
        <p>The following Document Action Request has been approved {{ $roleName }}.

            @if ($roleName === 'Manager Syd & IT')
                <p>And for this request has been completed </p>
            @endif
        </p>
        ...
        <div class="info-box">
            ...
            <p><span class="label">Approval Date:</span> 
                  {{ $approvalDate }}
            </p>
        </div>
        ...
        <p>
            @if ($roleName == 'Manager Syd & IT')
                <p>For this document action request process, it has been completed.</p>
            @else
                 <p> Please proceed with the necessary actions for this approved Document Request Action</p>
            @endif
