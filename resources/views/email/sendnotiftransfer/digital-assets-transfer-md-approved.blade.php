...
<body>
    ...
    <div class="content">
        ...
        <p>The following digital asset transfer request has been approved by Manager Directur:</p>
        ...
        <div class="info-box">
            ...
            <p><span class="label">Approval Date:</span> {{ $transferData->approval_date2 ?? '-' }}</p>
