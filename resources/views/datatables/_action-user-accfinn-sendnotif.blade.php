...
<div class="btn-group">
  <a href="{{ $show_url }}" data-href="{{ $show_url }}" data-id="{{ $model->id }}" 
    ...
    <a href="#" 
        ...
        row-approve4="{{ $model->approval_date4 }}"
        row-approve5="{{ $model->approval_date5 }}"
        row-approve6="{{ $model->approval_date6 }}"
        row-status1="{{ $model->approval_status1 }}"
        row-status2="{{ $model->approval_status2 }}"
        row-status3="{{ $model->approval_status3 }}"
        row-status4="{{ $model->approval_status4 }}"
        row-status5="{{ $model->approval_status5 }}"
        row-status6="{{ $model->approval_status6 }}"
        id="approval-data" 
