...
@section('title-head','News Management')
...
<section class="section">
	...
	<div class="section-header">
		...
		<div class="section-header-breadcrumb">
			...
			<div class="breadcrumb-item"><a href="#">News Management</a></div>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="table-responsive">
							<table class="table table-bordered dataTable no-footer" id="table-news-manage" width="100%" role="grid" aria-describedby="table-1_info">
								<thead>
									<tr>
										<th width="7%">No.</th>
...
<script>
		var table = $('#table-news-manage').DataTable({
			"columnDefs": [{
				"searchable": false,
				"orderable": false,
				"targets": 0,
...
$(document).on('click','#deleted-data-news', function(e){
	e.preventDefault();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.msg == true) {
                        ...
                        $('#table-news-manage').DataTable().ajax.reload();
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
...
$(document).on('click','#show-data-news', function(e){
       e.preventDefault()
        let id = $(this).data('id');
        let route = "{{ route('newsbe.show', ':id') }}";
