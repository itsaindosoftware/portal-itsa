<div class="modal fade" tabindex="-1" id="reject3-modal">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="rejectForm3" method="POST">
                    @csrf
                    <input type="hidden" name="id" id="reject3-id">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="reject_reason3" name="reject_reason2" rows="3"
            ...
            <div class="modal-footer bg-light">
                ...
                <button type="button" class="btn btn-danger submit-reject3">
